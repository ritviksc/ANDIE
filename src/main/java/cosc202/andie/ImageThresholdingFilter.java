 ...
 * 
 * <p>
 * The thresholding filter converts a colour image into black
 * and white image based on a specified intensity threshold. Pixels
 * with brightness above the threshold become white, and those below
 * become black. The original alpha (transparency) of the pixel is
 * preserved.
 * </p>
 * 
 * @author Maleena Taia
...
public class ImageThresholdingFilter implements ImageOperation {
   ...
   /**
    *<p>
    * The intensity threshold for black and white conversion.
    * Pixels with average brightness above this value become white,
    * others black
    * </p>
   */
    ...
    * </p>
    *
    * @param threshold The intensity threshold (0-255) used 
   ...
   */
    ...
    * 
    * <p>
    * Iterates through each pixel of the input image, calculates
    * its average brightness, and sets the output pixel to black
    * or white based on the threshold.
    * </p>
    * 
    * @param input The image to apply the threshold filter to.
    * @return A new BufferedImage where all pixels are black
    * or white based on the threshold.
   */
    @Override

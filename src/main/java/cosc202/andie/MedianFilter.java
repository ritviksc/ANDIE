 ...
 *
 * <p>
 * A median filter works by taking the average of each colour channel in each
 * pixel surrounding the current working pixel. It then sets the current pixel
 * to be the median of each colour channel.
 * </p>
 *
 * <p>
...
public class MedianFilter implements ImageOperation, java.io.Serializable {
    ...
    /**
     * The size of the cluster to apply. A radius of 1 is a 3x3 cluster, a
     * radius of 2 a 5x5 cluster, and so forth.
     */
    private int radius;
     ...
     * </p>
     *
     * @param input The image to apply the Median filter to (recommended less
     * than 10).
